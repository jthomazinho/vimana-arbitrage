...
export default function ExchangeOTC() {
  ...
  function onTextFieldBlur(evt: React.FocusEvent<HTMLInputElement>) {
    ...
    const isPercentage = ['spread-otc'].includes(name);
    ...
    <>
      ...
      <TableContainer className={classes.table} component={Paper}>
        <Table size="small" aria-label="simple table">
          <TableHead>
            <TableRow>
              <StyledTableCell>Spread OTC</StyledTableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            <TableRow>
              <TableCell key="spread-otc">
                <StyledTextField
                  value={fields['spread-otc'].value}
